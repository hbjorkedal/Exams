...
#let datafile := "hour.dat"; # Our initial bid on task 2
#let datafile := "hour2A.dat"; # Our final bid for task 2A
#let datafile := "hour2B.dat"; # Our final bid for task 2B
#let datafile := "blockbids_2.dat"; # Initial bid for task 3
let datafile := "blockbids_2_final.dat"; # final bid for task 3
